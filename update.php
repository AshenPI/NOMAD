...
//$sql = "UPDATE `users` SET `Email`='$Email',`Username`='$user',`Password`='$pass' WHERE `Id`='$id'  ";
$sql = "UPDATE `users` SET `Email`='$Email',`Username`='$user',`Password`='$pass' WHERE `USername`='$id1'  ";
...
<body>
  ...
  <div class="p-5 text-center ">
    <h1 class="mb-3"> <span>Updated </span> Sucessfuly</h1>
